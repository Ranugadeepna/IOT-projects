...
const Dustbincard = ({ id, level }) => {
    ...
    const [binPercentage, setBinPercentage] = (0, react_1.useState)('');
    (0, react_1.useEffect)(() => {
        updateDustbinStatus();
    }, [binLevel]);
    ...
    return (react_1.default.createElement("section", { className: "bin" },
        react_1.default.createElement("div", { className: "bin-card", id: id },
            react_1.default.createElement("div", { className: "bin-data" },
                react_1.default.createElement("p", { className: "bin-text" }, id),
                react_1.default.createElement("h1", { className: "bin-percentage" }, binPercentage),
                react_1.default.createElement("p", { className: "bin-status", dangerouslySetInnerHTML: { __html: binStatus } })),
            react_1.default.createElement("div", { className: "bin-pill" },
                react_1.default.createElement("div", { className: "bin-level" },
                    react_1.default.createElement("div", { className: `bin-liquid ${binLiquidColor}`, style: { height: binPercentage } }))))));
};
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"id":"866bb73c-a83b-4aac-9b46-029c6c0bf46b","author":"","widgets":[{"id":"wastelevel","name":"wastelevel","description":"A sample widget","icon":"","tags":[],"category":"","isTemplate":false}],"sidebarLinks":[],"uis":[],"menuItems":[]}');
