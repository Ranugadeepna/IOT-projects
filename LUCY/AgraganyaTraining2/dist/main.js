...
const Sample_1 = __importDefault(__webpack_require__(/*! ./components/Sample */ "./src/components/Sample.tsx"));
const AgraganyaTraining2Widget = (props) => {
    return (React.createElement(Sample_1.default, null));
};
/**
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"id":"1e07e76f-49ec-4794-bccb-f8cb3f2d84c5","author":"","widgets":[{"id":"AgraganyaTraining2","name":"AgraganyaTraining2","description":"A sample widget","icon":"","tags":[],"category":"","isTemplate":false}],"sidebarLinks":[],"uis":[{"id":"AgraganyaTraining2","label":"","description":"","roles":[]}],"menuItems":[]}');
