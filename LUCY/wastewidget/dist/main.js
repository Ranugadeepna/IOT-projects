...
const WastewidgetWidget = (props) => {
    const [capacity, setCapacity] = (0, react_1.useState)(0); // Initial capacity is 0
    const [statusColor, setStatusColor] = (0, react_1.useState)('green'); // Initial status color is green
    const [statusText, setStatusText] = (0, react_1.useState)('Not Full');
    (0, react_1.useEffect)(() => {
    ...
    return (React.createElement("div", { id: "dustbin-1", className: "dustbin-card" },
        React.createElement("div", { className: "card-header" },
            React.createElement("h3", null, "Smart Dustbin #1")),
        React.createElement("div", { className: "card-body" },
            React.createElement("div", { className: "visual-indicator" },
                React.createElement("div", { className: "visual-level", style: { height: `${capacity}%` } })),
            React.createElement("div", { className: "dustbin-status" },
                React.createElement("span", { className: "status-indicator", style: { backgroundColor: statusColor } }),
                React.createElement("span", { className: "status-text" }, statusText)),
            React.createElement("p", null, "Location: Central Park"),
            React.createElement("p", { className: "capacity" },
                "Capacity: ",
                capacity,
                "% Full"))));
};
